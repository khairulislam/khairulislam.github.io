...
* Jan 2025 - Arxiv preprint: [Scalable Cosmic AI Inference using Cloud Serverless Computing with FMI](https://arxiv.org/pdf/2501.06249) — introduces a new infrastructure for serverless computing using astronomy images and the AstroMAE foundation model.
