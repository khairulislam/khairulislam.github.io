...
I design generative and foundation models for scientific data, built to run without a supercomputer and to transfer across instruments and domains. I am a sixth-year Computer Science Ph.D. candidate at the [University of Virginia](https://engineering.virginia.edu/department/computer-science), advised by [Professor Judy Fox](https://judyfox.online/) and co-advised by [Professor Geoffrey Fox](https://engineering.virginia.edu/faculty/geoffrey-c-fox).

My research follows two threads. In generative and foundation models for science, [Cosmo3DFlow](https://dl.acm.org/doi/10.1145/3770855.3818994) (KDD 2026) replaces iterative diffusion sampling with wavelet flow matching, so reconstructing the early universe no longer requires hundreds of denoising steps; [OmniSpectra](https://arxiv.org/pdf/2601.15351) learns one representation of astronomical spectra across instruments, rather than a separate model for each; and [serverless inference](https://journals.sagepub.com/doi/full/10.1177/10943420251399942) (IJHPCA 2025) puts such models on demand in the cloud, without dedicated HPC allocations. In explainable time series deep learning, [WinTSR](https://arxiv.org/pdf/2412.04532) (AAAI 2025) recovers the delayed cause-and-effect relationships that point-wise attribution methods miss. Applied to COVID-19 forecasting, this line of work showed which population age groups drove transmission, earning **First Place** in the [2024 CIC Student Paper Challenge](https://covidinfocommons.datascience.columbia.edu/content/2024-cic-student-paper-challenge) and **Third Place** at the [NSF Student Research Competition, ICDH 2023](https://conferences.computer.org/icdh/2023/student_awards.html). I packaged these and 15+ other attribution methods into [tslens](https://github.com/khairulislam/tslens), a PyTorch library covering 25+ time series architectures.
